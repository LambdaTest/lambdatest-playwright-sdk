...
<p align="center">
  ...
  <a href="https://playwright.dev/"><img src="https://img.shields.io/badge/Playwright-SDK-45BA4B.svg?style=for-the-badge&logo=playwright&labelColor=000" alt="Playwright SDK"></a>
...
```bash
git clone https://github.com/LambdaTest/lambdatest-playwright-sdk
cd lambdatest-playwright-sdk
```
...
Run your Playwright tests using the SDK:
...
Enable the tunnel capability in your Playwright configuration:
